...
#
#              for k in range(r - s):    r - s in range; for r range(r>=s)
#                  count = 0             this line should be above line 53
#                  if math.cos(r) > 0:   r - > k
#                      count = 1 ->      count += 1
#                  return count          this is bad indents
#
